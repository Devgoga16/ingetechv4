      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 flex items-center justify-center min-h-[400px]">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-foreground/70 mb-8">
            La página que buscas no existe. Por favor, regresa a la página principal o
            contáctanos si necesitas ayuda.
          </p>
          <Link
            to="/"
            className="inline-block bg-secondary hover:bg-secondary/90 text-white px-8 py-3 rounded font-bold transition-colors"
          >
            Volver al Inicio
          </Link>
        </div>
